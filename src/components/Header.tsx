        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-gray-700">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-gray-900">
              <a href="#" className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-white">
                Product
              </a>
              <a href="#" className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-white">
                Pricing
              ...
              <div className="pt-4 pb-3 border-t border-gray-700">
                <button className="block w-full text-left px-3 py-2 text-base font-medium text-gray-300 hover:text-white">
                  Sign in
                </button>
